                        ...
                        <div class="col-md-6">
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    <img src="{{ asset('assets/images/logo.png') }}" class="img-responsive" width="50%" height="50">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    <img src="{{ asset('assets/images/favicon.png') }}" class="img-responsive" width="50%" height="50">
                                </div>
                            </div>
                        </div>
                    </div>

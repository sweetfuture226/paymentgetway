                        ...
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12"><strong style="text-transform: uppercase;">About Left Text</strong></label>
                                    <div class="col-md-12">
                                        <textarea name="about_leftText" id="area1" rows="10" class="form-control" required placeholder="About Left Text">{{ $page->about_leftText }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
